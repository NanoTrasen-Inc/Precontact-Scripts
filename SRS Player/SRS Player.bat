...
set srs-exe=C:\Program Files\DCS-SimpleRadio-Standalone\DCS-SR-ExternalAudio.exe
set servernumber=1
set freq=305.0
set modulation=AM
set volume=0.25
...
:: Play audio
"%srs-exe%" --file="%mp3file%" -f %freq% -m "%modulation%" -c 2 -n "%displayname%" -v %volume% -p 50%servernumber%2
